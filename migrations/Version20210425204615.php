 ...
 */
final class Version20210425204615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX idx_62615baf1b2bba7');
        $this->addSql('ALTER TABLE matches DROP nomination_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE matches ADD nomination_id INT DEFAULT NULL');
